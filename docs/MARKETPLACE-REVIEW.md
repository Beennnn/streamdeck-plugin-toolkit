...
[publishing.md → Upload media / Media gotchas](https://github.com/Beennnn/stream-deck-icons/blob/main/docs/publishing.md#store-previews):
...
*Maintained by BenLab. Distilled from real Marketplace rejections — add every new
one to the log above.*
